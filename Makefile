...
core_trace: core_trace.o process_file_list.o read_file.o libtiptrace.a utils/string_list.o
	$(CC) $(CFLAGS) -o $@ core_trace.o process_file_list.o read_file.o utils/string_list.o -L. -ltiptrace -lz -lm -lgif
...
libtiptrace.a: find_tips.o find_isoline.o calculate_tip_coordinates.o gifoutput.o
	$(AR) rcs $@ $^
